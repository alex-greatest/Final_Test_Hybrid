...
| FA_AlarmCondensat | Bool | %E13.0 | Газоанализатор. Неисправность Конде... |
| FA_AlarmGasLine | Bool | %E13.1 | Газоанализатор. Неисправность Линии ... |
| FA_AlarmGasCooler | Bool | %E13.2 | Газоанализатор. Неисправность Линии ... |
| FA_Trip | Bool | %E13.3 | Газоанализатор. Автоматы питания вкл... |
...
| FlexIn | Bool | %E15.3 | 17К2 GRKPTS IN |
...
| EV0_1_LeakDefFlame | Bool | %A12.2 | 18К2 LEAK DETECTION FLAME GAS. Не по... |
...
| FE5_DHW_In_Press | Int | %EW30 | FE5 Давление потока воды в контуре D... |
| PMB_CH_Flw_Press | Int | %EW32 | PMB Давление потока воды в контуре С... |
...
| TU5_DHW_Out_T | Int | %EW48 | TU5 Температура воды на выходе контура... |
| THA_CH_Pm_T | Int | %EW50 | THA Температура потока воды в контур... |
| TE2_DHW_In_T | Int | %EW46 | TE2 Температура воды на входе в контур... |
| TRM_CH_Rm_T | Int | %EW52 | TRM Температура обратной воды в конт... |
| HeatingPumpON | Bool | %A14.0 | PUMP1 Насос подачи воды из теплообм... |
...
| 30SB3 | Bool | %E56.3 | Кнопка Вверх |
| 30SB4 | Bool | %E57.0 | Кнопка Вверх |
...
| 32S5 | Bool | %E61.0 | Кнопка Включение насоса контура обогр... |
...
| Name | Data Type | Address | Comment |
|------|-----------|---------|---------|
| F5VJ3_1 | Bool | %E64.0 | Давление воздуха ОК |
| 2BS2 | Bool | %E64.2 | Заслонка дымовая закрыта |
| E64_1 | Bool | %E64.1 | Резерв |
| E64_3 | Bool | %E64.3 | Резерв |
| 2BS1 | Bool | %E64.4 | Заслонка дымовая открыта |
| VPO_1 | Bool | %A64.1 | Подача газа C20 |
| VPO_3 | Bool | %A64.0 | Подача сжиженного газа |
| VP1_1 | Bool | %A64.3 | СН Продажа |
| VP1_2 | Bool | %A64.2 | СН Продажа |
...
| VP1_7 | Bool | %A65.1 | СН Подача горячей воды в теплообмен... |
| VP1_8 | Bool | %A65.0 | СН Слив в обр. |
| VP1_9 | Bool | %A65.3 | Резерв |
| VP1_10 | Bool | %A65.2 | СН Подача горячей воды в теплообмен... |
| VP1_11 | Bool | %A65.5 | СН Слив |
| VP1_12 | Bool | %A65.4 | СН Межручное заполнение |
| VP2_1 | Bool | %A65.7 | DHW Продажа |
| VP2_2 | Bool | %A65.6 | DHW Продажа |
...
| VP3_2b | Bool | %A68.6 | Котел разблокировать (Адаптер внит) |
