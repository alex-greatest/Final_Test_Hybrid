...
| ID | Код | Описание |
|----|-----|----------|
| 1 | E9 | Блокировка при перегреве |
| 2 | EA | Блокировка зажигания |
| 3 | E2 | Неисправность датчика температуры подающей линии |
| 4 | A7 | Неисправность датчика температуры ГВС |
| 5 | Ad | Неисправность датчика температуры бойлера косвенного нагрева |
| 6 | A8 | Неисправен датчик наружной температуры |
| 7 | C7 | Не обнаружен тахосигнал с вентилятора |
| 8 | C6 | Пневматический выключатель не закрывается |
| 9 | C4 | Пневматический выключатель закрыт до начала нагрева |
| 10 | C1 | Вентилятор не может достичь заданных оборотов |
| 11 | FA | Неисправность клапанов регулятора давления газа |
| 12 | D7 | Неисправность модулирующей катушки регулятора давления газа |
| 13 | FL | Неисправность датчика контроля пламени |
| 14 | CE | Низкое давление воды в системе |
| 15 | CA | Высокое давление воды в системе |
| 16 | P | Не задан тип котла |
| 17 | 11 | Не задана ступень вентилятора |
| 18 | FD | Залипание кнопок |
| 19 | LA | Не достигается температура для термической дезинфекции |
| 20 | PE | Ошибка работы насоса (электропитание) |
| 21 | Pd | Ошибка работы насоса (отсутствие жидкости) |
| 22 | PA | Ошибка работы насоса (блокировка ротора) |
| 23 | F7 | Неисправность катушек клапанов регулятора давления газа |
| 24 | A9 | Невозможность нагрева бойлера из режима защиты от замерзания |
