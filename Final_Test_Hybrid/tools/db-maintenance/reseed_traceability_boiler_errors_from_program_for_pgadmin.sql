...
BEGIN
    ...
    ('П-109-02', 'Неисправность. Нет протока воды', 'Coms/CH_Start_Max_Heatout_Without'),
    ...
    ('П-205-03', 'Неисправность. Заданная температура не достигнута', 'DHW/Check_Flow_Temperature_Rise'),
    ('П-206-00', 'Неисправность. Стенд не готов', 'DHW/Get_Flow_NTC_Cold'),
    ('П-206-01', 'Неисправность. Слишком малый расход воды', 'DHW/Get_Flow_NTC_Cold'),
    ('П-206-02', 'Неисправность. Слишком большой расход воды', 'DHW/Get_Flow_NTC_Cold'),
    ...
    ('П-208-02', 'Неисправность. Заданная температура воды не достигнута', 'DHW/Compare_Flow_NTC_Temperature_Hot'),
    ('П-208-03', 'Неисправность. Слишком малый расход воды', 'DHW/Compare_Flow_NTC_Temperature_Hot'),
    ('П-208-04', 'Неисправность. Слишком большой расход воды', 'DHW/Compare_Flow_NTC_Temperature_Hot'),
    ...
    ('П-213-02', 'DB_Set_Tank_Mode. Неисправность. Давление выше заданного', 'DHW/Set_Tank_Mode'),
    ...
    ('П-301-03', 'Высокое давление воды', 'CH/Slow_Fill_Circuit'),
    ...
    ('П-305-10', 'Неисправность. Заданная температура воды не достигнута', 'CH/Compare_Flow_NTC_Temperatures_Hot'),
    ...
    ('П-307-11', 'Неисправность. Заданная температура не достигнута', 'CH/Check_Flow_Temperature_Rise'),
