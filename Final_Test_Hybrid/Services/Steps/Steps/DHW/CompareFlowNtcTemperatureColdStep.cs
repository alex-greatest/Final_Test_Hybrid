...
{
    private const string BlockPath = "DB_VI.DHW.Compare_Flow_NTC_Temperature_Cold";
    private const string StartTag = "ns=3;s=\"DB_VI\".\"DHW\".\"Compare_Flow_NTC_Temperature_Cold\".\"Start\"";
    private const string EndTag = "ns=3;s=\"DB_VI\".\"DHW\".\"Compare_Flow_NTC_Temperature_Cold\".\"End\"";
    private const string ErrorTag = "ns=3;s=\"DB_VI\".\"DHW\".\"Compare_Flow_NTC_Temperature_Cold\".\"Error\"";
    private const string Ready1Tag = "ns=3;s=\"DB_VI\".\"DHW\".\"Compare_Flow_NTC_Temperature_Cold\".\"Ready_1\"";
    private const string Continua1Tag = "ns=3;s=\"DB_VI\".\"DHW\".\"Compare_Flow_NTC_Temperature_Cold\".\"Сontinua_1\"";
    private const string FaultTag = "ns=3;s=\"DB_VI\".\"DHW\".\"Compare_Flow_NTC_Temperature_Cold\".\"Fault\"";
    ...
    private const string ParameterName = "Delta_DHW_Flow_Temp_Cold";
    private const ushort RegisterDhwTemperature = 1009;

    private readonly DiagnosticSettings _settings = settings.Value;

    public string Id => "dhw-compare-flow-ntc-temperature-cold";
    public string Name => "DHW/Compare_Flow_NTC_Temperature_Cold";
    public string Description => "Контур ГВС. Сравнение показаний температур холодной воды";
