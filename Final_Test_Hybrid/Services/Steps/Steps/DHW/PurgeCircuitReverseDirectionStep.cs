...
/// <summary>
/// Тестовый шаг продувки контура ГВС в обратном направлении.
/// </summary>
public class PurgeCircuitReverseDirectionStep(
    DualLogger<PurgeCircuitReverseDirectionStep> logger) : ITestStep, IHasPlcBlockPath, IRequiresPlcSubscriptions
{
    private const string BlockPath = "DB_VI.DHW.Purge_Circuit_Reverse_Direction";
    private const string StartTag = "ns=3;s=\"DB_VI\".\"DHW\".\"Purge_Circuit_Reverse_Direction\".\"Start\"";
    private const string EndTag = "ns=3;s=\"DB_VI\".\"DHW\".\"Purge_Circuit_Reverse_Direction\".\"End\"";
    private const string ErrorTag = "ns=3;s=\"DB_VI\".\"DHW\".\"Purge_Circuit_Reverse_Direction\".\"Error\"";
    ...
    /// <summary>
    /// Выполняет шаг продувки контура ГВС в обратном направлении.
    /// </summary>
    ...
    {
        logger.LogInformation("Запуск продувки контура ГВС в обратном направлении");
    ...
    private async Task<TestStepResult> WaitForCompletionAsync(TestStepContext context, CancellationToken ct)
    {
        ...
        return waitResult.Result switch
        {
            ...
            PurgeResult.Error => TestStepResult.Fail("Ошибка продувки контура ГВС"),
    ...
    {
        logger.LogInformation("Продувка контура ГВС в обратном направлении завершена успешно");
