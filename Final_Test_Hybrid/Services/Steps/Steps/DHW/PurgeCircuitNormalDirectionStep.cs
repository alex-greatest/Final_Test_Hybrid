    ...
    DualLogger<PurgeCircuitNormalDirectionStep> logger) : ITestStep, IHasPlcBlockPath, IRequiresPlcSubscriptions
{
    ...
    private const string EndTag = "ns=3;s=\"DB_VI\".\"DHW\".\"Purge_Circuit_Normal_Direction\".\"End\"";
    private const string ErrorTag = "ns=3;s=\"DB_VI\".\"DHW\".\"Purge_Circuit_Normal_Direction\".\"Error\"";
