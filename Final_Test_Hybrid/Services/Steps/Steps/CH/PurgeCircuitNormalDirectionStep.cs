...
/// <summary>
/// Тестовый шаг продувки контура отопления в прямом направлении.
/// </summary>
...
{
    private const string BlockPath = "DB_VI.CH.Purge_Circuit_Normal_Direction";
    private const string StartTag = "ns=3;s=\"DB_VI\".\"CH\".\"Purge_Circuit_Normal_Direction\".\"Start\"";
    private const string EndTag = "ns=3;s=\"DB_VI\".\"CH\".\"Purge_Circuit_Normal_Direction\".\"End\"";
    private const string ErrorTag = "ns=3;s=\"DB_VI\".\"CH\".\"Purge_Circuit_Normal_Direction\".\"Error\"";
    ...
    /// <summary>
    /// Выполняет шаг продувки контура отопления в прямом направлении.
    /// </summary>
    ...
    {
        logger.LogInformation("Запуск продувки контура отопления в прямом направлении");
    ...
    {
        logger.LogInformation("Продувка контура отопления в прямом направлении завершена успешно");
