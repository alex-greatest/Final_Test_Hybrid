...
/// <summary>
/// Тестовый шаг открытия клапанов контура газа.
/// </summary>
public class OpenCircuitStep(
    DualLogger<OpenCircuitStep> logger) : ITestStep, IHasPlcBlockPath, IRequiresPlcSubscriptions
{
    private const string BlockPath = "DB_VI.Gas.Open_Circuit";
    private const string StartTag = "ns=3;s=\"DB_VI\".\"Gas\".\"Open_Circuit\".\"Start\"";
    private const string EndTag = "ns=3;s=\"DB_VI\".\"Gas\".\"Open_Circuit\".\"End\"";
    private const string ErrorTag = "ns=3;s=\"DB_VI\".\"Gas\".\"Open_Circuit\".\"Error\"";
    ...
    /// <summary>
    /// Выполняет шаг открытия клапанов контура газа.
    /// </summary>
    ...
    {
        logger.LogInformation("Запуск открытия клапанов контура газа");
    ...
    /// <summary>
    /// Ожидает завершения операции открытия клапанов.
    /// </summary>
