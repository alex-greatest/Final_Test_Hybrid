...
/// <summary>
/// Тестовый шаг проверки давления и расхода газа на минимальной мощности.
    ...
    : ITestStep, IHasPlcBlockPath, IRequiresPlcSubscriptions, IRequiresRecipes, IProvideLimits
{
    ...
    private const string EndTag = "ns=3;s=\"DB_VI\".\"Gas\".\"Check_Gas_and_P_Burner_Min_Levels\".\"End\"";
    private const string ErrorTag = "ns=3;s=\"DB_VI\".\"Gas\".\"Check_Gas_and_P_Burner_Min_Levels\".\"Error\"";
    ...
    /// <summary>
    /// Выполняет шаг проверки параметров газа на минимальной мощности.
    /// </summary>
    ...
    {
        logger.LogInformation("Запуск проверки параметров газа в минимальном режиме");
        ...
        try
        {
            ...
            context.RangeSliderUiState.SetTitle("Проверка параметров газа в минимальном режиме");
    ...
    /// <summary>
    /// Обрабатывает завершение: чтение значений из PLC (без сохранения результатов).
    /// </summary>
        ...
        CancellationToken ct)
    {
        ...
        logger.LogInformation(
            "Результаты проверки: Blr_Gas_Pres_Min={BlrPress:F3}, Gas_Flow_Min={Flow:F3}, Bnr_Gas_Pres_Min={BnrPress:F3}, статус={Status}",
