...
public static class BoilerErrors
{
    private static readonly Dictionary<ushort, BoilerErrorInfo> Errors = new()
    {
        ...
        [1] = new BoilerErrorInfo(1, "E9", "Блокировка при перегреве"),
        [2] = new BoilerErrorInfo(2, "EA", "Блокировка зажигания"),
        [3] = new BoilerErrorInfo(3, "E2", "Неисправность датчика температуры подающей линии"),
        [4] = new BoilerErrorInfo(4, "A7", "Неисправность датчика температуры ГВС"),
        [5] = new BoilerErrorInfo(5, "Ad", "Неисправность датчика температуры бойлера косвенного нагрева"),
        [6] = new BoilerErrorInfo(6, "A8", "Неисправен датчик наружной температуры"),
        [7] = new BoilerErrorInfo(7, "C7", "Не обнаружен тахосигнал с вентилятора"),
        [8] = new BoilerErrorInfo(8, "C6", "Пневматический выключатель не закрывается"),
        [9] = new BoilerErrorInfo(9, "C4", "Пневматический выключатель закрыт до начала нагрева жидкого теплоносителя"),
        [10] = new BoilerErrorInfo(10, "C1", "Вентилятор не может достичь заданных оборотов"),
        [11] = new BoilerErrorInfo(11, "FA", "Неисправность входного и (или) выходного клапанов регулятора давления газа"),
        [12] = new BoilerErrorInfo(12, "D7", "Неисправность модулирующей катушки регулятора давления газа"),
        ...
        [17] = new BoilerErrorInfo(17, "11", "Не задана ступень вентилятора"),
        [18] = new BoilerErrorInfo(18, "FD", "Залипание кнопок"),
        ...
        [21] = new BoilerErrorInfo(21, "Pd", "Ошибка работы насоса, связанная с возможным отсутствием поступления жидкости в ротор"),
